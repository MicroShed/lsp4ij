 ...
 ******************************************************************************/
package org.microshed.lsp4ij.features.foldingRange;
...
public class LSPFoldingRangeBuilder extends CustomFoldingBuilder {
    ...
    protected void buildLanguageFoldRegions(@NotNull List<FoldingDescriptor> descriptors,
        ...
        try {
            CompletableFutures.waitUntilDone(foldingRangesFuture, file);
        ...
        if (CompletableFutures.isDoneNormally(foldingRangesFuture)) {
