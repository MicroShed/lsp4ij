 ...
 ******************************************************************************/
package org.microshed.lsp4ij.features.documentation;
...
import org.microshed.lsp4ij.features.completion.LSPCompletionProposal;
    ...
    public String generateDoc(@NotNull PsiElement element, @Nullable PsiElement originalElement) {
        try {
            ...
            if (element instanceof LSPPsiElementForLookupItem) {
                ...
                try {
                    CompletableFutures.waitUntilDone(hoverFuture, psiFile);
                ...
                if (CompletableFutures.isDoneNormally(hoverFuture)) {
            ...
            return styleHtml(editor, MarkdownConverter.toHTML(s));
        } finally {
